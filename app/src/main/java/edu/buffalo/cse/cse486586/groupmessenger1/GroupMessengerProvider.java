...
public class GroupMessengerProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        Log.i(TAG,"insert function: file creation step");
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        try{
            ...
            InputStreamReader ip_stream = new InputStreamReader(inputStream);
            BufferedReader line_reader = new BufferedReader(ip_stream);

            while((read_line = line_reader.readLine()) != null)
            {
                Log.i(TAG, "read_line:");
                Log.i(TAG, read_line);
                Log.i(TAG, "----");

                stringBuilder.append(read_line);
            ...
            Log.e(TAG, "Error: File read step");
        }
        ...
        try{
            String[] matrixRow = {selection,String.valueOf(stringBuilder)};
        ...
        return matCur;  //code change here
    }
}
